...
function create_partitions() {
    ...
    # Create partitions by manipulating stdin for fdisk
...
function base_install() {
    ...
    pacstrap /mnt base base-devel linux-lts linux-lts-headers git python3 bash-completion &> /dev/null && \
