...
syn keyword	cConstant	GTK_WINDOW GTK_HEADER_BAR GTK_STACK GTK_GRID GTK_STACK_SWITCHER GTK_STACK_SIDEBAR
syn keyword	cConstant	GTK_CONTAINER GTK_BIN

" Gtk Widgets
syn keyword	cType		GtkWidget GtkButton GtkLabel GtkToggleButton GtkEntry
syn keyword	cType		GtkImage GtkSwitch GtkComboBox GtkComboBoxText
syn keyword	cType		GtkStyleContext GtkCssProvider
syn keyword	cConstant	GTK_WIDGET GTK_BUTTON GTK_LABEL GTK_TOGGLE_BUTTON GTK_ENTRY
syn keyword	cConstant	GTK_IMAGE GTK_SWITCH GTK_COMBO_BOX GTK_COMBO_BOX_TEXT
syn keyword	cConstant	GTK_STYLE_CONTEXT GTK_CSS_PROVIDER
syn keyword	cConstant	GTK_STYLE_PROVIDER
syn keyword     cConstant       GTK_TYPE_WINDOW GTK_TYPE_GRID GTK_TYPE_HEADER_BAR
syn keyword     cConstant       G_OBJECT G_OBJECT_CLASS

" GLib
syn keyword     cType           g_malloc g_free gboolean g_printf g_getenv
syn keyword     cType		gint gchar gdouble gfloat
syn keyword     cType           GType GObject GObjectClass
syn keyword	cOperator	g_strcmp0 g_strlcpy g_strlcat ?
syn keyword     cConstant       TRUE FALSE
syn keyword	cConstant	G_CALLBACK

" i/o and string things
syn keyword     cType           fopen fclose
syn keyword     cOperator       strlen strcpy strcat mkdir remove
