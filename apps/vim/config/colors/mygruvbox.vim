...
let s:gb.dark0_hard  = ['#ffffff', 234]     "
let s:gb.dark0       = ['#21242c', 235]     " Background
let s:gb.dark0_soft  = ['#ffffff', 236]     "
let s:gb.dark1       = ['#292d37', 237]     " Current line
let s:gb.dark2       = ['#292d37', 239]     " Side line
let s:gb.dark3       = ['#000000', 241]     " Marked text
let s:gb.dark4       = ['#363e48', 243]     " Info bar
let s:gb.dark4_256   = ['#ffffff', 243]     "
...
let s:gb.bright_purple  = ['#d3869b', 175]     " Numbers, TRUE, FALSE
